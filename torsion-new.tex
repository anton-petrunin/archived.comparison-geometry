...
The orthonormal basis $\tan(s),\norm(s),\bi(s)$ is called \index{Frenet frame}\emph{Frenet frame} at $s$; the vectors in the frame are called \index{tangent}\emph{tangent}, \index{normal}\emph{normal} and \index{binormal}\emph{binormal} respectively.\label{page:frenet-frame}
