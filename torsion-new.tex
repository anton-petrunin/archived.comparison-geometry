...
Since $B$ is the normal vector to the osculating plane, Equation \ref{eq:frenet-beta} shows that the torsion measures how fast the osculating plane rotates when one travels along $\gamma$.
