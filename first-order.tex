...
The affine tangent plane can be interpreted as the best approximation at\nobreakspace$p$ of the surface $\Sigma$ by a plane.
More precisely, 
...
\parit{Proof.}
Fix a chart $s$ at $p$.
Assume $\gamma$ is a smooth curve that starts at\nobreakspace$p$.
