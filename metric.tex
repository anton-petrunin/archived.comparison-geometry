...
In this case we also use shortcut notations $|x-y|$ or $|x-y|_{\mathcal X}$  for the {}\emph{distance $\Dist(x,y)$ from $x$ to $y$ in $\mathcal X$}.\index{10aaa@$\lvert x-y\rvert$, $\lvert x-y\rvert_{\spc{X}}$}
