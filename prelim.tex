...
Observe that $Q$ and $R$, which by the induction hypothesis are $(k\z-2)\cdot\pi$ and $(m-2)\cdot\pi$ correspondingly
...
All the $2\cdot m\cdot n$ equal triangles form a polyhedral surface which is called Schwarz's boot.
