...
An open set $\Omega$ that contains a given point $p$ is called a \index{neighborhood}\emph{neighborhood of\nobreakspace$p$}.
A closed subset $C$ that contains $p$ together with its neighborhood is called a {}\emph{closed neighborhood of\nobreakspace$p$}
...
$\bm{x}$ is a \index{regular!point}\emph{regular point} of\nobreakspace$\bm{f}$.
