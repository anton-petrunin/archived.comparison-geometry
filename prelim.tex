...
An ammusing proof of general statement for smooth regular curves can be found in \cite{chambers-liokumovich}; we use this theorem mostly in this (much simpler) case.
