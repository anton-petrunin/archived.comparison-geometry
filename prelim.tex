...
\index{Borel subsets}\emph{Borel subsets} are defined as the class of subsets that generated from open sets by applying the following operations recursively: countable union, countable intersection, and complement.
Since complement of closed set is open and the other way around these sets can be also generated from all closed sets.
...
The following theorem characterize homeomorphisms between compact spaces.
