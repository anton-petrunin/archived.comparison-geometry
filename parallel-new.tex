...
Let $R$ be a region that a closed geodesics cuts from a smooth closed surface $\Sigma$.
Show that 
\[\iint_R K\le 2\cdot 2\cdot\pi.\]
...
Note tha Gauss--Bonnet formula states that 
\[\GB(\Delta)=0.\]
...
\[\GB(\Norm(\Delta))=\tgc{\beta}_{\SS^2}+\area[\Norm(\Delta)]-2\cdot \pi=0.\]
Therefore 
