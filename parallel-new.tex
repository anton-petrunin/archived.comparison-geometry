...
(Indeed, by pushing axis one cannot produce torque to spin the wheel.)
...
\parit{Hint.} Note that it is sufficient to show that the surface has no geodesic loops.
