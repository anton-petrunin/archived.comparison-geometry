...
then the surface is said to be \index{strictly saddle surface}\emph{strictly saddle};
...
Recall that a set $R$ in the plane is called \index{star-shaped set}\emph{star-shaped} if there is a point $p\in R$ such that for any $x\in R$ the line segment $[p,x]$ belongs to~$R$.
