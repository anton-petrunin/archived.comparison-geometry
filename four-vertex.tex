...
Consider an arc $\alpha_1$ of $\alpha$ that runs from $p_1$ to the next point in $D_1$.
Denote by $F_1$ the set bounded by $\alpha_1$ and the part of boundary of $D_1$ that containing $D_1$.
