...
\begin{thm}{Exercise}
Assume a closed smooth regular plane curve $\alpha$ runs inside of a triangle $\triangle$ with inradius 1; that is, the  inscribed circle or $\triangle$ has radius 1.
Show that there is a point on $\alpha$ with curvature at least~$1$.
\end{thm}
...
Therefore $p_3$ lies on the extension of $xy$ behind $y$ and the arc $p_2p_3$ of $\alpha$ surrounds $F$.
Whence
\[\Conv \alpha_2\supset \alpha_1.\]
\qedsf
