...
Let $\Sigma$ be a smooth regular surface with nonnegative Gauss curvature.
Suppose a closed broken geodesic $x_1\dots x_n$ cuts from $\Sigma$ a disc $\Delta$ with positive exterior angles; that is, when you travel along the boundary, you always turn to the side where $\Delta$ is.
...
Use \ref{SHORT.ex:convex-polyhon} to show that a closed geodesic in  a smooth regular sphere with positive Gauss curvature
Show that $\gamma$ cannot look like the curves on the diagram in some chart.
\end{subthm}
