...
The points $x,y,z$ are called {}\emph{vertices} of the geodesic triangle,
...
A triangle $[\tilde x\tilde y\tilde z]$ in the plane $\mathbb{R}^2$ is called \index{model!triangle}\emph{model triangle} of the triangle $[xyz]$
...
The corresponding angle $\measuredangle\hinge {\tilde x}{\tilde y}{\tilde z}$ in the model triangle $[\tilde x\tilde y\tilde z]=\tilde\triangle xyz$ is denoted by $\modangle xyz$.
...
Since $\dist{x}{y}{\Sigma},\dist{x}{z}{\Sigma}\z<\tfrac r2$, the triangle inequality implies that $\gamma$ lies in $r$-neighborhood of $x$.
...
\side \hinge x q p\ge\dist{\tilde p}{\tilde q}\Sigma.\]
...
\]
Therefore
$\dist{\tilde p}{\tilde q}\Sigma\ge\side \hinge{x'}q p$ and \ref{eq:thm:=def-loc-fivestar} follows.
...
$\dist{p}{q}{}\ge |\tilde p-\tilde q|$ (or, respectively, $\dist{p}{q}{}\le |\tilde p-\tilde q|$).
...
The function  $\bus_\lambda\:\Sigma\z\to \mathbb{R}$ as in the proposition is called 
