...
A \index{geodesic triangle}\emph{geodesic triangle} in a surface $\Sigma$ is defined as a triple of points $x,y,z\in \Sigma$ with choice of minimizing geodesics $[x,y]_\Sigma$, $[y,z]_\Sigma$ and $[z,x]_\Sigma$.
