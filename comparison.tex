...
If $\Sigma$ is proper, then a minimizing geodesic always exists. %%%???should we prove it???
...
Let $\Sigma$ be a proper smooth regular surface with a geodesic triangle $[xyz]$.
\begin{enumerate}[(i)]
...
Let $\Sigma$ be an open smooth regular simply connected surface with nonpositive Gauss curvature.
