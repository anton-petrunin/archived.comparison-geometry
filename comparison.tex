...
\\
|x-\vec v|_{\T_x}&=|x-y|_\Sigma, 
\\
|x-\vec w|_{\T_x}&=|x-z|_\Sigma.
\end{align*}
...
\begin{thm}{Exercise}Let $\Sigma$ be an open smooth regular surface
...
$\trig{\tilde p}{\tilde x}{\tilde z_y}\cong\trig {\dot p}{\dot x}{\dot z}$ 
and 
$\trig{\tilde p}{\tilde y}{\tilde z_x}\cong\trig {\dot p}{\dot y}{\dot z}$
...
Define $F$ as follows.
\begin{itemize}
\item Map  $\solidtriangle{\tilde p}{\tilde x}{\tilde z_y}$ isometrically onto  $\solidtriangle {\dot p}{\dot x}{\dot y}$;
similarly map $\solidtriangle{\tilde p}{\tilde y}{\tilde z_x}$ onto $\solidtriangle {\dot p}{\dot y}{\dot z}$.
