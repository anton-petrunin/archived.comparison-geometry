...
\begin{thm}{Advanced exercise}\label{ex:convex-polyhon}
Assume a disc $\Delta$ lies in an open smooth regular surface $\Sigma$ with nonnegative Gauss curvature and bounded by a closed broken geodesic $x_1\dots x_n$ with positive exterior angles; that is, when you travel along the boundary, you always turn to the side where $\Delta$ is.
