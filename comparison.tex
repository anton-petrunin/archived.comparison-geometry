...
that is,
\[\dist{\tilde x}{\tilde y}{\RR^2}=\dist{x}{y}\Sigma,
\quad
\dist{\tilde y}{\tilde z}{\RR^2}=\dist{y}{z}\Sigma,
\quad
\dist{\tilde z}{\tilde x}{\RR^2}=\dist{z}{x}\Sigma.
\]
...
Then the following expressions have the same signs:
\begin{enumerate}[(i)]
 \item $\dist{p}{y}\Sigma-\dist{\tilde p}{\tilde y}{\RR^2}$;
...
and therefore
\[\dist{w}{y}\Sigma\ge \dist{\tilde w}{\tilde y}{\RR^2},\]
