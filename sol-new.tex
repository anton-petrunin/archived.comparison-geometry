...
Show that there is $\delta>0$ such that any path of length at most $\dist{x}{y}{\RR^3}+\delta$ passes thru $B(z,\epsilon)$.
It follows that $\dist{x}{y}A\ge \dist{x}{y}{\RR^3}+\delta$, 
...
Since $t=\dist{\tilde p}{\tilde x}{\RR^2}$ is small, so is the distances $\dist{\tilde q}{\tilde y}{\RR^2}$.
Therefore we can choose a point $y$ on $\delta$ such that $\dist{q}{y}\Sigma=\dist{\tilde q}{\tilde y}{\RR^2}$.
...
\angk q x y.
\end{align*}
Therefore $\dist{x}{y}\Sigma\le \dist{\tilde x}{\tilde y}{\RR}$.
Since $\tilde\phi\le\phi$, we get that
\begin{align*}
f\circ\gamma(t)&\le \dist{x}{y}\Sigma\le 
\dist{\tilde x}{\tilde y}{\RR}=
\\
&=
