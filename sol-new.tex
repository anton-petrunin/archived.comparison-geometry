...
\parbf{\ref{ex:9}.}
For \ref{SHORT.ex:9:compact}, use the fact that a continuous bijection with compact domain is a homeomorphism.
For \ref{SHORT.ex:9:9}, the image of $\gamma$ might have the shape of the digit $8$ or $9$.
...
\parbf{\ref{ex:zero-curvature-curve}.} For a unit-speed parameterization $\gamma$, the velocity $\gamma ^{\prime}$ has to be constant, hence $\gamma $ is an affine function $\gamma(t) = p+tq$ for some $p,q \in \mathbb{R}^3$.
