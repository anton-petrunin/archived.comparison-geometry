...
&=a\cdot b\cdot(\ell\cdot n-m^2)=a\cdot b\cdot K.
...
\end{align*}
The required identity follows since the left hand sides in the last two equations are identical.
