...
\parbf{\ref{ex:conformal}.} Apply \ref{lem:K(orthogonal)} and simplify.

\parbf{\ref{ex:deformation}.} Show that Gauss curvature equals to 1 at every point of $\Sigma_\gamma$ and use \ref{ex:K=1}.
