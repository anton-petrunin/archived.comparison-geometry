...
Then for each point $p\in \Omega$ there is $\epsilon>0$ such that $|p-q|_{\spc{X}}>\epsilon$ for any $q\in Q$.
...
Show that there is $\delta>0$ such that any path of length at most $|x-y|_{\RR^3}+\delta$ passes thru $B(z,\epsilon)$.
