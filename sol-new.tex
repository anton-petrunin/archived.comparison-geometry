...
Observe that $\tgc\gamma=\lenght\gamma$ and apply  the Gauss--Bonnet formula (\ref{thm:gb}) for $\Delta$.
...
Apply the Gauss--Bonnet formula (\ref{thm:gb}) to show that the loops surround regions with integral of Gauss curvature $\pi+\alpha$, $\pi+\beta$, and $\pi+\gamma$ correspondingly.
