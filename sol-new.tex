...
\parit{Direct solution.} We may assume that $\gamma$ is a unit-speed curve and $p=\gamma(0)$.
...
Direct calculations show that $f'(0)=0$ and $f''(0)=0$ therefore $f'''(0)=0$.
It remains to perform calculations and show that the latter implies that $\kappa'(0)=0$.
