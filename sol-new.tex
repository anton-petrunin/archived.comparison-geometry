...
\parbf{\ref{ex:thin}.} 
Let us define the \index{cut locus}\emph{cut locus} of $V$ as the closure of the set of points $x\in V$ such that there are at least two points on $\partial V$ that minimize the distance to $x$.
...
Show that its cut locus $L$ is formed by a few smooth surfaces that meet by three at their boundary points.
