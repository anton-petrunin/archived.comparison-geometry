...
Observe that $\alpha (t) \df  \gamma_{\lambda} (t/\lambda )$ is a unit-speed parameterization of the curve $ \gamma_{\lambda}$. Apply the chain rule twice.
...
Apply \ref{prop:S=-D} together with the following identities:
...
Use that mean curvature is the trace of the Hessian matrix.
...
Whence the signed curvature of $\gamma$ has definite sign.
