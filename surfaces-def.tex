...
It remains to apply the definition of smooth surface (Section\nobreakspace\ref{sec:def-smooth-surface}).
\qeds
...
such that $w(0,0)=(0,0)$ and  $s\circ w(x,y)=(x,y,f(x,y))$ for some smooth function\nobreakspace$f$.
...
However, any smooth surface $\Sigma$ admits a local parametrization; that is, any point $p\in\Sigma$ admits an open neighborhood $W\subset \Sigma$ with a smooth regular parametrization\nobreakspace$s$.
