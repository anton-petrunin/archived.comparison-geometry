...
A connected set $\Sigma \subset \mathbb{R}^3$ is called a \index{smooth surface}\emph{smooth surface} (or more precisely {}\emph{smooth regular embedded surface}) if it can be described locally as a graph of a smooth function in an appropriate coordinate system.
%???+regular???spoken term
