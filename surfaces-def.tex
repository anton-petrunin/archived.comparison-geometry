...
Moreover, if $(u,v)\mapsto s(u,v)$ is a local chart at $p=s(u_p,v_p)$, and $\vec{w}=a\cdot s_u(u_p,v_p)+b\cdot s_v(u_p,v_p)$, then 
...
\begin{align*}
\gamma'(0)&=u'(0)\cdot s_u(u_p,v_p)+v'(0)\cdot s_v(u_p,v_p).
\end{align*}
