...
A connected subset $\Sigma$ in a metric space is called a \emph{topological surface} (more precisely an \emph{embedded surface without boundary}) 
...
The complement of any proper topological surface without boundary (or, equivalently any open or closed topological surface) in the Euclidean space has exactly two connected components. 
\end{thm}
