...
This definition can be applied to any \emph{Borel set} of $R\subset \Sigma$.
...
The latter is shown by a classical example --- the so-called \emph{Schwarz's boot}; it is discussed in
Section~\ref{sec:schwarz-boot}.
