...
\eqlbl{eq:hessian}
\]
it is called the \index{Hessian matrix}\emph{Hessian matrix} of $f$ at $(0,0)$.
...
\[M_p=\begin{pmatrix}
  ...
  \end{pmatrix},
\]
the diagonal components $k_1$ and $k_2$ of $M_p$ are called \index{principle curvatures}\emph{principle curvatures} of $\Sigma$ at $p$;
...
The product 
\[K=k_1(p)\cdot k_2(p)\]
is called \index{Gauss curvature}\emph{Gauss curvature} at $p$.
...
Since $M_p$ is symmetric, $S$ is \index{self-adjoint operator}\emph{self-adjoint}; that is
