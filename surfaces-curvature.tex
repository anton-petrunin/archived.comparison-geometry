...
\eqlbl{eq:hessian}
\]
it is the so-called the \index{Hessian matrix}\emph{Hessian matrix} of $f$ at $(0,0)$.\index{10m@$M_p$}
...
\[M_p=\begin{pmatrix}
  ...
  \end{pmatrix},
\]
the diagonal components $k_1$ and $k_2$ of $M_p$ are called \index{principle curvatures}\emph{principle curvatures} of $\Sigma$ at $p$;\index{10k@$k_1$, $k_2$}
...
is called \index{10k@$K$}\index{Gauss curvature}\emph{Gauss curvature} at $p$.
