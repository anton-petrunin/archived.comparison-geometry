...
\[M_p=\begin{pmatrix}
  ...
  \end{pmatrix},
\]
the diagonal components $k_1$ and $k_2$ of $M_p$ are called the \index{principal curvatures}\emph{principal curvatures} of $\Sigma$ at $p$;\index{10k@$k_1$, $k_2$}
...
The eigendirections of $M_p$  are called the \index{principal directions}\emph{principal directions} of $\Sigma$ at~$p$.
