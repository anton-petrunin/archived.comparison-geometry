...
The line thru $\gamma(t)$ in the direction of $\tan(t)$ is called the \index{tangent!line}\emph{tangent line} of $\gamma$  at\nobreakspace$t$.
...
Show that a closed space curve $\gamma$ with curvature at most\nobreakspace$1$ cannot be shorter than the unit circle;
that is, 
...
a number of them are collected by Serge Tabachnikov\nobreakspace\cite{tabachnikov}.
...
The assumption that the intervals of definition of $\alpha$ and $\beta$ fit together is not essential --- one can concatenate any of the curves as long as the endpoint of $\alpha$ coincides with the starting point of\nobreakspace$\beta$.
...
\[\tc\gamma=\sup\{\tc\beta\},\]
where the least upper bound is taken over all polygonal lines\nobreakspace$\beta$ inscribed in $\gamma$
...
according to the exercise the latter implies the so-called \index{F\'ary--Milnor theorem}\emph{F\'ary--Milnor theorem} --- the total curvature of any knot exceeds\nobreakspace$4\cdot \pi$.
