...
The curvature is usually denoted by $\kur(s)$ or $\kur(s)_\gamma$ %??? do I need it
and in the latter case it might be also denoted by $\kur(p)$ or $\kur(p)_\gamma$. %??? do I need it
...
Then the distance between the ends of $\gamma_1$ can not exceed the  distance between the ends of $\gamma_2$; that is,
