...
Let $\gamma\:[a,b]\to\RR^3$ be a regular smooth curve and $\tau$ its tangent indicatrix.
...
Then
\begin{align*}
\tc\gamma&\df\int_a^b\kur(s)\cdot ds=
\\
...
Other proofs of this theorem are discussed by Serge Tabachnikov \cite{tabachnikov}.
The following closely related result is annoyingly difficult;
it was proved by Jeffrey Lagarias and Thomas Richardson in \cite{lagarias-richardso}, a simpler proof was given by Alexander Nazarov and Fedor Petrov in \cite{nazarov-petrov}.
