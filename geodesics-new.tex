...
Otherwise, if a definition of a property essentially uses the ambient space, then it is called \index{extrinsic}\emph{extrinsic}.

For instance, the mean curvature as well as the Gauss curvature are defined via principle curvatures, which are extrinsic.
...
In general there might be no shortest path between two given points on a surface
