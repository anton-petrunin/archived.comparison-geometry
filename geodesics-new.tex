...
The property of exponential map in \ref{prop:exp} can be used to define polar coordinates in a smooth surface $\Sigma$ with respect to a point $p\in \Sigma$.
...
The following statement is known as \index{Gauss lemm}\emph{Gauss lemma},
...
A proof will be given at the end of the section. 
...
\parit{Proof of \ref{prop:gamma''}.}\label{sec:proof-of-gamma''}
