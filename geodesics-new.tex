...
Given a tangent vector $v$ to $\Sigma$ at a point $p$
...
This connection will be important later; in particular it will play the key role in the proof of the so-called \emph{remarkable theorem} (\ref{thm:remarkable}).
...
\[\langle \gamma''(t),\Norm_{\gamma(t)}\rangle=\II_{\gamma(t)}(\gamma'(t),\gamma'(t));\]
hence
\[\gamma''(t)=\Norm_{\gamma(t)}\cdot \II_{\gamma(t)}(\gamma'(t),\gamma'(t))\]
for any $t$.

Therefore
\[z''(t)=\cos(\theta_\gamma(t))\cdot\Norm_{\gamma(t)}\cdot \II_{\gamma(t)}(\gamma'(t),\gamma'(t)),\eqlbl{eq:z''}\]
