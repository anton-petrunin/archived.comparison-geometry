...
\[ \gamma_{\lambda}: \left( \frac{-1}{\lambda} , \frac{1}{\lambda} \right) \to \Sigma   \]
...
As one can see from the previous exercise, a geodesics might fail to be a shortest path. A geodesic that is also a shortest path is called a  \index{minimizing geodesic}\emph{minimizing geodesic}.
