...
\parit{Comment.}
Another proof of \ref{lem:perimeter} can be built on the closest point projection discuses on page \pageref{closest point projection}.  
...
\end{align*}
This formula and its relatives are called \index{Crofton formula}\emph{Crofton formulas}.
