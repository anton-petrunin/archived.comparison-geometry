...
for some $k \in \mathbb{R}$. The exact value of $k$ can be found by integration, but we will soon show another way to find it. % the value of k is 1 / (average of $| cos |$)
...
\end{align*}
This formula and its relatives are called the \index{Crofton formula}\emph{Crofton formulas}. % Who is Crofton? Name?
...
Crofton's formula holds for arbitrary rectifiable curves, not necessary smooth; this can be proved using Exercise~\ref{adex:integral-length}.
