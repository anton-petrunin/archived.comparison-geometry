...
If the equality holds for all pairs, then the metric $|{*}-{*}|$ is said to be a \index{length-metric}\emph{length-metric} and the corresponding metric space is called a \index{}\emph{length-metric space}.
