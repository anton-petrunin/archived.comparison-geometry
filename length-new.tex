...
Let $\gamma\:[a,b] \to\RR^3$ be a curve and the function $\phi : [c,d] \to [a,b]$ is an monotonic continuous and $\phi(c)=a$, $\phi(d)=b$.
We call the curve $\gamma \circ \phi$ a 
\emph{reparametrization} of $\gamma$.
Show that $\length (\gamma \circ \phi) = \length \gamma$.
\end{thm}
