...
А cowboy stands at the bottom of a frictionless ice-mountain formed by a cone with a circular base with  angle  of inclination\nobreakspace$\theta$.
...
By the definition of induced length-metric (Section\nobreakspace\ref{sec:Length metric}),
...
Without loss of generality, we can assume that all the points $x_n$ lie in a ball of radius $\ell+1$ centered at\nobreakspace$p$.
...
Since $R$ is convex, their midpoint $m=\tfrac12\cdot (\bar p+\bar p')$ lies in\nobreakspace$R$.
Note that $|p-\bar p|\z=|p-\bar p'|=\ell$; that is, the triangle $[p\bar p\bar p']$ is isosceles and therefore the triangle $[p\bar p m]$ is right with the right angle at\nobreakspace$m$.
...
Indeed, consider the closest point projection $\bar\gamma$ of\nobreakspace$\gamma$.
