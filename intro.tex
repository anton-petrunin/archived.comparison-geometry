...
If you go with  ``Comparison geometry'' \cite{cheeger-ebin} --- the good old classics by Jeff Cheeger and David Ebin , then you might be surprised to see that almost all of it already is already known.
