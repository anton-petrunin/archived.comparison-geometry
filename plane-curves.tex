...
Suppose that $\gamma$ is a closed simple plane curve which is smooth regular everywhere except one point $p$ and the absolute curvature $\gamma$ does not exceed 1 at all points except $p$.
...
\begin{thm}{Exercise}
List the modifications in the proof of \ref{thm:moon} which are nesesary to prove \ref{thm:moon-gen}.
\end{thm}
