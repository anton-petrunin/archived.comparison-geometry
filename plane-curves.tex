...
The pair $\tan(s),\norm(s)$ is an oriented orthonormal frame in the plane which is analogous to the Frenet frame defined on page \pageref{page:frenet-frame}; we will keep the name \index{Frenet frame}\emph{Frenet frame} for it.
...
For more on the geometry of bicycle tracks, see \cite{foote-levi-tabachnikov} and the references therein.
...
Consider the family of \index{trochoid}\emph{trochoids} $\gamma_a\:[0,2\cdot\pi]\to \RR^2$ defined by 
