...
A proof of this statement would take us away from the subject, so we will omit it. We hope that the statement is intuitively clear, but a full proof can be found in . % a formal proof can be found in Munkres, I have it in my office. Will go to check which page.
