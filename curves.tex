...
Recall that a \index{real interval}\emph{real interval} is defined as a connected subset of the real numbers.
...
It turns out that any simple curve $\gamma$ can be \index{parametrization of curve}\emph{parametrized} by a real interval or the circle.
