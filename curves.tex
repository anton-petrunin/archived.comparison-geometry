...
Any smooth regular closed curve can be described by a \index{periodic parametrization}\emph{periodic} parametrized curve $\gamma\: \mathbb{R}\to \spc{X}$; that is, a curve such that $\gamma(t+\ell)=\gamma(t)$ for a fixed period $\ell > 0$ and all $t$.
